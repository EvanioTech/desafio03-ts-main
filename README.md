...
[ ] Crie uma página para exibir as informações do usuário
 ok - Crie uma página onde será exibido o nome, email
 ok - Esta página só poderá ser acessada caso a usuária esteja logada
 ok - Caso a usuária não esteja logada, deve ser mantida na página com a tela de login
  ok - Escreva os testes unitários para as funções criadas ou refatoradas.
